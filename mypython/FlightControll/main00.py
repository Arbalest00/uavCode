...
com_gpio =[170,1,64,255]#发送给esp32/arduino的数据 GPIO输出 帧头/蜂鸣器/小于64收，大于64放
run_sign=False
##########################################  任务  #############################################
